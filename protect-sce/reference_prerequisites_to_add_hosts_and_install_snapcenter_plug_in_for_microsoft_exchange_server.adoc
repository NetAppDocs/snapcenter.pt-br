...
* Você deve estar usando Microsoft Exchange Server para configurações autônomas e de Database Availability Group. Consulte a link:https://imt.netapp.com/imt/#search["Ferramenta de Matriz de Interoperabilidade (IMT)"^] para as versões compatíveis do Microsoft Exchange Server.
...
* Certifique-se de que as seguintes portas não estejam bloqueadas no firewall, caso contrário, a operação de adição de host falhará. Para resolver esse problema, você deve configurar o intervalo de portas dinâmico. Para mais informações, consulte  https://docs.microsoft.com/en-us/troubleshoot/windows-server/networking/configure-rpc-dynamic-port-allocation-with-firewalls["Documentação da Microsoft"^]. Consulte o link:https://imt.netapp.com/imt/#search["Ferramenta de Matriz de Interoperabilidade (IMT)"^] para as versões compatíveis do Microsoft Exchange Server.
+
** Intervalo de portas 49152 - 65536 para Windows 2019
** Intervalo de portas 50000 - 51000 para Windows 2016 e Exchange 2016
** Faixa de portas 6000 - 6500 para Windows 2012 R2 e Exchange 2013
...
Pacotes de software necessários
 a| 
* ASP.NET Core Runtime 8.0.24 (e todos os patches 8.0.x subsequentes) Hosting Bundle
* PowerShell 7.4.13
* (Oracle Java ou OpenJDK) (ou Java 11 para SnapCenter 6.2)
