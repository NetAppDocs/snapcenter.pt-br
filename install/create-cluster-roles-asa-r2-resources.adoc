...
summary: Você deve criar funções de cluster do ONTAP para sistemas ASA R2 para que não seja necessário usar a função de administrador do ONTAP para executar operações no SnapCenter. 
---
