...
Opcionalmente, você pode executar vários procedimentos de instalação e configuração usando PowerShell cmdlets. Você deve estar usando PowerShell 7.4.13 ou posterior.
