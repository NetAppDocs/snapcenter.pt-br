...
NOTE: A partir do 5,0, os usuários de administração do vserver só são suportados com APIS REST. Se você quiser criar funções usando um administrador que não seja vserver, use o ZAPI.
