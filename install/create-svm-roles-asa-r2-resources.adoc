...
summary: Você deve criar funções SVM se você configurar SVMs em sistemas ASA R2 para usar com o SanpCenter e não quiser usar a função vsadmin. 
---
...
[role="lead"]
Há vários comandos de CLI do ONTAP que você precisa executar para criar uma função para um novo usuário SVM nos sistemas ASA R2. Essa função é necessária se você configurar SVMs em sistemas ASA R2 para usar com o SnapCenter e não quiser usar a função vsadmin.
