...
Consulte link:https://techdocs.broadcom.com["Documentação técnica Broadcom"^] e pesquise a documentação sobre clustering de máquinas virtuais em hosts físicos e criação de LUN compartilhado FC RDM para clusters Microsoft.
