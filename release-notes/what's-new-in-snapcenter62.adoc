...
summary: A versão 6.2 do SnapCenter software inclui diversos novos recursos e melhorias. 
---
...
[role="lead"]
A versão 6.2 do SnapCenter software inclui o seguinte recurso expandido.
