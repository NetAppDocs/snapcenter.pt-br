...
+
link:../protect-db2/task_configure_gMSA_on_windows_server_2012_or_later.html["Configurar conta de serviço gerenciado de grupo no Windows Server 2016 ou posterior para IBM DB2"^]
...
.Depois de terminar
Se você quiser atualizar para a versão do SnapCenter 6,0, o plug-in baseado EM PERL existente para DB2 será desinstalado do servidor de plug-in remoto.
