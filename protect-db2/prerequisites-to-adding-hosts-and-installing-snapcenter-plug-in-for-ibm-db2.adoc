...
* Você deve ter o Java 17 instalado no seu host.
+
...
* Você precisa ter o Java 17 instalado em seu host Windows.
+
...
* Você deve ter habilitado a conexão SSH baseada em senha para o usuário root ou não root.
* Você deve ter o Java 17 instalado em seus hosts Linux ou AIX.
+
