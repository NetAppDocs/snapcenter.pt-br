...
* Você deve ter o Java 17 ou o Java 11 (para SnapCenter 6.2 apenas) instalados no seu host.
+
...
* Você deve ter o Java 17, o Java 11 (para SnapCenter 6.2 apenas) instalados no seu host Windows.
+
...
* Você deve ter habilitado a conexão SSH baseada em senha para o usuário root ou não root.
* Você deve ter instalado Java 17, Java 11 (para SnapCenter 6.2 somente) em seus hosts Linux ou AIX.
+
link:https://www.oracle.com/java/technologies/downloads/#java17["Baixe o Java para Linux"^]

+
link:https://developer.ibm.com/languages/java/semeru-runtimes/downloads/?license=IBM["Baixe o Java para AIX"^]
