...
+
link:https://www.oracle.com/java/technologies/javase/jdk11-archive-downloads.html["Baixe JAVA para Windows"^]
...
* Você deve ter habilitado a conexão SSH baseada em senha para o usuário root ou não root.
* Você deve ter o Java 11 instalado em seus hosts Linux ou AIX.
+
link:https://www.oracle.com/java/technologies/javase/jdk11-archive-downloads.html["Baixe JAVA para Linux"^]

+
link:https://developer.ibm.com/languages/java/semeru-runtimes/downloads/?license=IBM["Baixe JAVA para AIX"^]
