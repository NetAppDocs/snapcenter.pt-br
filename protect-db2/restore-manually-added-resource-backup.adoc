...
---
= Restaurar um backup de recursos adicionado manualmente
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
.. Se você selecionar *Complete Resource*, todos os volumes de dados configurados do banco de dados IBM DB2 serão restaurados.
+
...
NOTE: <instance_name> é para o recurso de instância DB2 descoberta manualmente e UID: <instance_name> é para o recurso de <databse_name> banco de dados IBM DB2. Você pode obter o ResourceID do cmdlet Get-smResources.
