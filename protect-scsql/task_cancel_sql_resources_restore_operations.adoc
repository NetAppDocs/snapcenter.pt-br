...
Painel da atividade
 a| 
. Depois de iniciar a operação de restauração, clique image:../media/activity_pane_icon.gif["ícones no painel de atividades"]no painel atividade para exibir as cinco operações mais recentes.
