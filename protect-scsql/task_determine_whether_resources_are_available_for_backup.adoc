...
+
Clique image:../media/filter_icon.png[""] e selecione o nome do host e a instância do SQL Server para filtrar os recursos. Em seguida, pode clicar image:../media/filter_icon.png[""] para fechar o painel de filtro.
