...
* Você deve ter o Java 17 ou o Java 11 (para SnapCenter 6.2 apenas) instalados em seu host Linux.
+
...
Pacotes de software necessários
 a| 
Java 17 (Oracle Java ou OpenJDK), Java 11 (para SnapCenter 6.2 somente)
