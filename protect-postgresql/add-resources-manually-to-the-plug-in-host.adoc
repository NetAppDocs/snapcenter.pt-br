...
* Quando você modifica os recursos adicionados manualmente que são migrados do SnapCenter 5,0 ou abaixo, faça o seguinte na página *Configurações de recurso* para pares de valores de chave personalizados:
+
