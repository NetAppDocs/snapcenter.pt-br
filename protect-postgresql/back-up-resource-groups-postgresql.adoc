...
+
Você pode pesquisar o grupo de recursos inserindo o nome do grupo de recursos na caixa de pesquisa ou image:../media/filter_icon.png["ícone de filtro"]selecionando e selecionando a tag. Em seguida, pode image:../media/filter_icon.png["ícone de filtro"]selecionar para fechar o painel de filtro.
