...
+
link:../protect-postgresql/configure-gMSA-on-windows-server-2012-or-later.html["Configurar conta de serviço gerenciado de grupo no Windows Server 2016 ou posterior para PostgreSQL"^]
