...
* Você deve ter o Java 17 ou o Java 11 (para SnapCenter 6.2 apenas) instalado em seu host Linux, Windows ou AIX.
+
...
+
Se você estiver usando Windows Server 2019 ou Windows Server 2016 para o host do servidor SnapCenter, será necessário instalar o Java 17, Java 11 (para SnapCenter 6.2 apenas).
...
Pacotes de software necessários
 a| 
Java 17, Java 11 (para SnapCenter 6.2 somente), IBM Java
