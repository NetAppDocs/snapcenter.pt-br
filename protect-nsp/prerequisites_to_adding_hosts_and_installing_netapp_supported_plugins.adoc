...
* Você deve ter instalado o Java 17 (Oracle Java ou OpenJDK) para SnapCenter 6.2.1 ou posterior ou
* Java 11 para SnapCenter 6.2 e anteriores em seu host Linux, Windows ou AIX.
+
...
+
link:https://www.oracle.com/java/technologies/downloads/#java17["Baixe o Java para Windows"]
...
+
Se você estiver usando Windows Server 2019 ou Windows Server 2016 para o host do servidor SnapCenter, será necessário instalar o Java 17 (Oracle Java ou OpenJDK) para SnapCenter 6.2.1 e posteriores ou o Java 11 para SnapCenter 6.2 e anteriores.

+
link:https://www.oracle.com/java/technologies/downloads/#java17["Baixe o Java para Linux"]

+
https://developer.ibm.com/languages/java/semeru-runtimes/downloads/?license=IBM["Baixe o Java para AIX"]
...
Pacotes de software necessários
 a| 
* Java 17 para SnapCenter 6.2.1 e posterior, IBM Java ou
* Java 11 para SnapCenter 6.2 e versões anteriores, IBM Java
