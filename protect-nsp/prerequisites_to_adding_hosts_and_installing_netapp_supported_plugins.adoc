...
* Você precisa ter o Java 17 instalado em seu host Linux, Windows ou AIX.
+
...
* Você precisa ter o Java 17 instalado em seu host Linux.
+
Se você estiver usando Windows Server 2019 ou Windows Server 2016 para o host do servidor SnapCenter, será necessário instalar o Java 17.
