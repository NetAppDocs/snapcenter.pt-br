...
* Você precisa ter instalado Java 17, Java 11 (para SnapCenter 6.2 somente) em seu host Linux ou AIX.
+
...
NOTE: Certifique-se de ter instalado apenas a edição certificada do Java 17, Java 11 (para SnapCenter 6.2 somente) no host Linux.
...
Pacotes de software necessários
 a| 
Java 17 (Oracle ou OpenJDK), Java 11 (para SnapCenter 6.2 somente)
...
Pacotes de software necessários
 a| 
IBM Java 17, IBM Java 11 (para SnapCenter 6.2 somente)
