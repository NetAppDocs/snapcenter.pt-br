...
* Certifique-se de que PowerShell 7.4.13 esteja instalada no host do plug-in do Windows.
* Certifique-se de que o Java 17 (Oracle Java ou OpenJDK) esteja instalado nos hosts de plug-in do Windows e do Linux (ou Java 11 para SnapCenter 6.2 apenas).
