...
. Selecione *Verificar atualizações* para ver se há versões mais recentes dos pacotes de plug-in disponíveis.
. Selecione *Agendar atualizações* para criar um agendamento e especificar o intervalo em que deseja receber informações sobre as atualizações disponíveis:
+
