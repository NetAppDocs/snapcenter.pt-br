...
+
O SnapCenter usa a tecnologia Snapshot do NetApp com plug-ins personalizados para fazer backup de recursos. Os snapshots consomem espaço mínimo de storage.
