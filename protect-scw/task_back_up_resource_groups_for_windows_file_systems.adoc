...
+
Você pode pesquisar o grupo de recursos inserindo o nome do grupo de recursos na caixa de pesquisa ou clicando image:../media/filter_icon.png[""] e selecionando a tag. Em seguida, pode clicar image:../media/filter_icon.png[""] para fechar o painel de filtro.
