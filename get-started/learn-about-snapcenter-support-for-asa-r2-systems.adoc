...
NOTE: Após você atualizar para SnapCenter 6.2.1 (servidor e plug-ins) e ONTAP 9.17.1, SnapCenter altera grupos de consistência plana para grupos de consistência hierárquica durante o primeiro backup agendado.
