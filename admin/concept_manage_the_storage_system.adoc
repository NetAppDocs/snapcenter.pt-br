...
Todas as conexões de armazenamento com sistemas de armazenamento ONTAP e ASA R2 passarão por ZAPI por padrão. A API REST pode ser ativada para versões selecionadas do ONTAP.
